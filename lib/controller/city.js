...
module.exports = {
    xmlFromIpLookup: function(result, cityObject, ip) {
        ...
        geo.e('location', {'latitude': latitude.toString(), 'longitude': longitude.toString()});
    ...
    xmlFromQueryLookup: function(adminCodes, data, cityName, countryName) {
        ...
        _.each(data, function(o) {
            ...
            geo.e('location', {'latitude': o.pin.location.lat.toString() || '', 'longitude': o.pin.location.lon.toString() || ''});
