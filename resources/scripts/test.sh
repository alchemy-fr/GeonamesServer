...
bash "$SCRIPT_DIR/indexing/deleteIndex.sh" "$elastic_scheme://$elastic_host:$elastic_port/$elastic_cluster_test/"
echo ""
bash "$SCRIPT_DIR/indexing/createIndex.sh" "$elastic_scheme://$elastic_host:$elastic_port/$elastic_cluster_test/"
echo ""
bash "$SCRIPT_DIR/indexing/setupIndex.sh" "$elastic_scheme://$elastic_host:$elastic_port/$elastic_cluster_test/cities/_mapping" "cities"
echo ""
while read line; do curl --silent -XPOST "$elastic_scheme://$elastic_host:$elastic_port/$elastic_cluster_test/cities" -d "$line"; done < "$FIXTURE_DIR/indexes" > /dev/null
